...
import mainlogo from "../../assets/images/logotwo.png";
  ...
  return (
    <Container className="widthcontainer py-lg-4 py-3">
      <div className="d-lg-block d-none pb-3 py-5">
        <span className="px-3 listitemsone">Salud</span>
        <span className="px-3 listitems">Belleza</span>
        <span className="px-3 listitems">Cocina</span>
        <span className="px-3 listitems">Suplementos Dietéticos</span>
        <span className="px-3 listitems">Equipo de Entrenamiento</span>
      </div>
      <div>
        <h1 className="effecktivheading mb-0 pt-lg-0 pt-5">
          Estar delgado: Comparación de los 5 mejores productos para adelgazar
          en 2023
        </h1>
      </div>
      <div className="py-3">
        <img src={smallwomenimage} alt="No Display" />
        <span className="px-lg-3 px-2 erma-heading">Verónica Llanos</span>
      ...
      <div className="py-2">
        ...
        <p className="mb-0 py-3">
          <b>Ingredientes:</b> Werfen Sie einen sorgfältigen Blick auf die
      ...
      <div className="pt-1">
        ...
        <p className="mb-0 py-3">
          <b>Calidad y origen:</b> Achten Sie auf die Qualität der verwendeten
          Inhaltsstoffe und deren Herkunft. Produkte, die aus nachhaltigen,
          hochwertigen Quellen stammen, neigen dazu, effektiver und schonender
      ...
      <div className="pt-1">
        ...
        <p className="mb-0 py-3">
          <b>Efectos secundarios: </b> Informieren Sie sich über mögliche
      ...
      <div className="pt-1">
        ...
        <p className="mb-0 py-3">
          <b>Dosis recomendada:</b> Befolgen Sie strikt die empfohlene Dosierung
          des Produkts. Die Einhaltung dieser Richtlinien ist entscheidend, um
          Ihre Sicherheit und die Wirksamkeit des Produkts zu gewährleisten.
        </p>
      </div>
      <div className="pt-1">
        <Button className="allbuttons">5</Button>
        <p className="mb-0 py-3">
          <b>Atención al cliente: </b>Prüfen Sie, ob der Hersteller guten
      ...
      <div className="pt-1">
        ...
        <p className="mb-0 py-3">
          <b>Opiniones sobre el producto: </b> Lesen Sie Erfahrungsberichte und
      ...
      <div className="pt-1">
        ...
        <p className="mb-0 py-3">
          <b>Relación calidad-precio:</b> Berücksichtigen Sie das
      ...
      <div className="pt-1">
        ...
        <p className="mb-0 py-3">
          <b>Efectos a largo plazo:</b> Denken Sie daran, dass nachhaltige
      ...
      <div className="pt-1">
        ...
        <p className="mb-0 py-3">
          <b>Estado de salud: </b> Wenn Sie gesundheitliche Probleme oder
      ...
      <div>
        <h3 className="pltx mb-0 py-3">
          Los 5 mejores suplementos para adelgazar en nuestra clasificación
        </h3>
        <p className="mb-0 py-1 dieparatwo">
      ...
      <div>
        <div className="d-flex py-4">
          ...
          <div className="pt-4 px-3">
            <h4 className="mb-0 pltx">Primer puesto y ganado del test</h4>
      ...
      >
        <div className="text-center">
          <span className="vorteile">Ventajas</span>
      ...
      >
        <div className="text-center py-4">
          <span className="Nachteile">Desventajas</span>
        </div>
        <div>
          <p className="greenpara mb-0 px-2">
      ...
      <div className=" pb-3">
        ...
        <div className="px-lg-5 px-md-5 px-3 pb-4 pt-5 text-center">
          <h1 className="headingg py-3 text-white px-1 mb-0">
            Ver Disponibilidad de Gomitas Adelgazantes
          </h1>
        </div>
      </div>
      <div className=" pb-3">
        <div className="d-flex py-4">
          ...
          <div className="pt-4 px-3">
            <h4 className="mb-0 pltx">2 puesto</h4>
      ...
      >
        <div className="text-center">
          <span className="vorteile py-5">Ventajas</span>
          <img className="okay px-3 pb-3" src={okay} alt="NO Display" />
        </div>
        <div>
      ...
      <div className="pb-3">
        <div className="d-flex py-4">
          <div className="pt-4 px-3">
            <h4 className="mb-0 pltx">Tercer puesto</h4>
      ...
      <div className=" pb-3">
        <div className="d-flex py-4">
          <div className="pt-4 px-3">
            <h4 className="mb-0 pltx">Cuarto puesto</h4>
      ...
      <div className="pb-3">
        <div className="d-flex py-4">
          <div className="pt-4 px-3">
            <h4 className="mb-0 pltx">Quinto puesto</h4>
      ...
      <div className="pb-3">
        <div>
          <div className="pt-5 pb-4">
            <b> Conclusiones sobre KetoXplode</b>
          </div>
          <p className="mb-0 dieparatwo">
        ...
        <div className="px-lg-5 px-md-5 px-3 pb-4 pt-5 text-center">
          <h1 className="headingg py-3 text-white px-1 mb-0">
            Ver Disponibilidad de KetoXplode
          </h1>
        </div>
      </div>
      ...
      <div className="pb-3">
        <div>
          <div className="py-4">
            <b>Nuestra conclusión general:</b>
          </div>
      ...
      <div className="py-4">
        ...
        <div className="text-center pt-4">
          Control de Calidad | 2023. All rights Reserved
        </div>
