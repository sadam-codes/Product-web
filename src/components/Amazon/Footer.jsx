...
import naturallogo from "../../assets/images/natuallogo.png";

function AllData() {
  return (
    <Container className="widthcontainer pt-5 pb-2 px-2">
     <div className="py-2">
      ...
      <div className="py-4">
        ...
        <img src={naturallogo} alt="No Dsiplay" />
        </div>
        <div className="text-center pt-4">
        Natural MD, 2023. All rights Reserved
        </div>
